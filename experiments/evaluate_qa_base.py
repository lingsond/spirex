...
if __name__ == '__main__':
    ...
    for model in models:
        for qver in qvers:
            # input_file = f'./results/base_{model}_q{qver}.jsonl'
            input_file = f'./base_{model}_q{qver}_crosscheck.jsonl'
            print(f'Evaluating {input_file}')
            input_run = load_json_lines(input_file)
            # output_file = f'./evaluation/baseline_{model}_q{qver}.txt'
            output_file = f'./evaluation/baseline_{model}_q{qver}_crosscheck.txt'
